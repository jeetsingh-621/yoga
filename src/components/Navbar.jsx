...
function Navbar() {
  ...
  return (
    ...
    <div className=''>
    <div
        className={`flex w-full fixed min-h-[screen] flex-col  py-28  overflow-hidden items-center justify-center gap-4 sm:gap-6 font-semibold  bg-red-400  transition-all duration-300 bg-ebony ${showNavBar
          ? "top-20 left-0 w-full  z-[100] "
          : "-left-full top-20 w-full "
          }`}
      >
