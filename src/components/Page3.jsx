  ...
  return (
    <div className='w-full   '>
      <div className="first w-full flex flex-col xl:flex-row">
        ...
        <div className='   px-2  xl:pl-52 py-10 xl:py-44 xl:w-[65%] w-full'>
      ...
      <div className="second w-full flex items-center justify-between xl:flex-row flex-col-reverse">
        <div className=' px-2 xl:px-24 xl:py-28 py-10 xl:w-[55%] w-full relative'>
        ...
        <img className='w-full max-w-[500px] px-2 md:mx-auto md:w-[380px] xl:w-full h-full object-cover' src={yoga3} alt="" />
        </div>
